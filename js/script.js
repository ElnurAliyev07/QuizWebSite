...
const scriptSources = ['questions_html.js', 'questions_cpp.js', 'questions_java.js', 'questions_py.js', 'questions_sql.js'];

buttons.forEach((button, index) => {
    button.addEventListener('click', function(event) {
        event.preventDefault();
        
        // Load the corresponding script based on the index of the clicked button
        const scriptElement = document.createElement('script');
        scriptElement.src = scriptSources[index];
        scriptElement.onload = function() {
            // Code to run after the script is loaded
            console.log(`${scriptSources[index]} loaded`);
        };
        document.body.appendChild(scriptElement);

        // Add specific functionality for each button click here
        if (index === 0) {
            // Code for Html button click
            console.log('Html button clicked');
        } else if (index === 1) {
            // Code for C++ button click
            console.log('C++ button clicked');
        } else if (index === 2) {
            // Code for Java button click
            console.log('Java button clicked');
        } else if (index === 3) {
            // Code for Python button click
            console.log('Python button clicked');
        } else if (index === 4) {
            // Code for SQL button click
